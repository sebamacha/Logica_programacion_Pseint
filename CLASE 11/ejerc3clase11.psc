...
Algoritmo ejerc3_clase11
	definir usuario, contrasena, opciones Como Caracter
	definir botellas, i, j, intentos Como Entero
	definir saldo, peso Como Real
    ...
    si  usuario = "Albus_D" entonces
		...
		leer contrasena
		intentos<-1
		Mientras contrasena  <> "caramelosDeLimon" o intentos < 3   Hacer
			intentos = intentos + 1
			escribir "ingrese nuevamente contraseña"
			leer contrasena
		Fin Mientras
		si intentos > 3 Entonces
			escribir "a superado el numero de intentos"	
		sino 
			escribir "la constraseña es correcta"
			login=verdadero
		FinSi
	sino 
