...
Algoritmo sin_titulo
	definir cantidadmails, solejecutivos Como Entero
	definir emergencia Como logico
	escribir "hola, gracias por cubrirme"
	escribir "completar hora de calculos mensuales"
	escribir "ingrese cantidad de correos"
	leer cantidadmails
	escribir " V O F si ay emergencias"
	leer emergencia
	si cantidadmails < 10 
		Entonces 
			si emergencia = Verdadero entonces
			escribir "ver emergencia"
			escribir "leer correo"
			escribir "escuchar correo de vos"
		
		escribir "revisar correo de vos"
		sino escribir "revisar mails"
			FinSi
		
	escribir "revisar los mails"	
	escribir "reenviar solicitudes actualizadas"
	FinSi
FinAlgoritmo
