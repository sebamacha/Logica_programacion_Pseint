...
//Aleatorio(limite_inferior, limite_superior) de PseInt.
	Definir nroRandom,nro Como Entero
	nroRandom=Aleatorio(1,10)
	
	Repetir
		escribir "Ingrese un Nro."
		leer nro
		si nro <>nroRandom Entonces
			si nro < nroRandom Entonces
				escribir "El nro. Ingresado es Menor al Aleatorio"
			SiNo
				Escribir "El Nro. ingresado es Mayor al Aleatorio"
			FinSi
		FinSi
	Mientras Que nro<>nroRandom
	
	escribir "Nro. ALeatorio: ", nroRandom, " su nro.: ", nro
FinAlgoritmo
